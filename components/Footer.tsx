            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                     <div className="text-center md:text-left text-sm text-gray-500">
                        <p>&copy; 2025 Katuni. All rights reserved.</p>
                        <div className="flex items-center justify-center md:justify-start gap-x-4 gap-y-1 mt-2 flex-wrap">
                            <span>Phone: 0775919085</span>
                            <span className="hidden md:inline">|</span>
                            <a href="mailto:sales@magamutu.com" className="hover:text-lime-400 transition-colors">Email: sales@magamutu.com</a>
                        </div>
                    </div>
                    <div className="flex justify-center space-x-5">
                        <a href="#" className="text-gray-500 hover:text-lime-400 transition-colors" aria-label="Katuni on Twitter">
                           <TwitterIcon />
                        </a>
                        <a href="#" className="text-gray-500 hover:text-lime-400 transition-colors" aria-label="Katuni on GitHub">
                           <GithubIcon />
                        </a>
                    </div>
                </div>
